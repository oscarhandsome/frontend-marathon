...
const changeBG = function(e, filterStatus) {
    ...
    */
    ...
    mainContainer.style.filter = filterStatus ? "blur(2px)" : 'none';
}
...
document.querySelector('.btn-prev').addEventListener("click", changeBG(e, false))
document.querySelector('.btn-next').addEventListener("click", changeBG(e, false))